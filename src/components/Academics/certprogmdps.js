        ...
        <div>
            ...
            <Container className="About_us11 container">
                ...
                <Row>
                    ...
                    <Col lg={9}>
                        <h2 className="linkabout123">Certificate Programs And Mdps</h2>
                        <p class="AboutSection__desc">Overview</p>
                        <p className="detail_text">Short term certificate programs are conducted to enhance the skill of the youth the programs are trailer
                            maid to meet the requirements of the bossiness and industries .
                            List of common certificate programs are listed below-</p>
                        <ul class="AboutSection__list">
                            <li>
                                ...
                                <div class="AboutSection__list__label">Certificate in Taxation</div>
                            </li>
                            <li>
                                <div class="AboutSection__list__icon">
                                    <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                </div>
                                <div class="AboutSection__list__label">Certificate in GST modules</div>
                            </li>
                            <li>
                                <div class="AboutSection__list__icon">
                                    <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                </div>
                                <div class="AboutSection__list__label">Certificate in Telly</div>
                            </li>
                            <li>
                                <div class="AboutSection__list__icon">
                                    <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                </div>
                                <div class="AboutSection__list__label">Certificate in e -commerce
                                </div>
                            </li>
                            <li>
                                <div class="AboutSection__list__icon">
                                ...
                                <div class="AboutSection__list__label">Certificate in m- commerce</div>
                            </li>
                            <li>
                                <div class="AboutSection__list__icon">
                                    <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                </div>
                                <div class="AboutSection__list__label">Certificate in GMP
                                </div>
                            </li>
                            <li>
                                <div class="AboutSection__list__icon">
                                ...
                                <div class="AboutSection__list__label">Certificate in Computer literacy</div>
                            </li>
                            <li>
                                <div class="AboutSection__list__icon">
                                    <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                </div>
                                <div class="AboutSection__list__label">Certificate in workshop maintenance
                                </div>
                            </li>
                            <li>
                                <div class="AboutSection__list__icon">
                                ...
                                <div class="AboutSection__list__label">Certificate in water shed management</div>
                            </li>
                        </ul>
                    </Col>
                </Row>
...
export default Certificateemdps