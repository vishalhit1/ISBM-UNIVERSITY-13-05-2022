...
const Mdp_on_strategy_consultancy = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage">
                <div className="text_banners_abcds">
                    ...
                    Mdp on strategies for online businesses
                    </h1>
                    <button
            ...
            <Container className="About_us11">
                ...
                <Breadcrumb.Item active>Mdp on strategies for online businesses</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                <Col lg={3}>
...
export default Mdp_on_strategy_consultancy