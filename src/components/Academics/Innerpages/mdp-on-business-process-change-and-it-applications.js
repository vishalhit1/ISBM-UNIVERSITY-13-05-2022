...
const Mdp_on_business_process_change_and_it_applications = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage">
                <div className="text_banners_abcds">
                    ...
                    MDP on Business Process Change and IT Applications
                    </h1>
                    <button
            ...
            <Container className="About_us11">
                ...
                <Breadcrumb.Item active>MDP on Business Process Change and IT Applications</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
...
export default Mdp_on_business_process_change_and_it_applications