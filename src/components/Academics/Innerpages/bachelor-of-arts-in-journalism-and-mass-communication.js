...
const Bachelor_of_arts_in_journalism_and_mass_communication = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage3">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">Bachelor of Journalism &amp; Mass Communication (BJMC) is an undergraduate program that provides <br />
                        aspirants with knowledge about various journalistic skills in mass media such as newspapers, television,<br />
                        radio, internet etc. It also informs students about various technology, <br /> equipment and software involved in
                        mass media.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Bachelor of Arts in Journalism and Mass Communication (BA-JMC)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Bachelor of Arts in Journalism and Mass Communication (BA-JMC)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">The duration of the course is three years and is divided into six equal semesters.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">BJMC is a right career choice for the aspirants who have always been curious and inquisitive
                                            about the issues and events happening around the world.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Students get best practical knowledge so they can stand in the field on their own.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Journalism Faculty has been equipped with all the latest professional equipment required for the
                                            overall growth of the student.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">At the end of the program student gains proficiency reads to newspapers, television, radio, digital
                                            content management, social media, advertising, public relations, event management,
...
export default Bachelor_of_arts_in_journalism_and_mass_communication;