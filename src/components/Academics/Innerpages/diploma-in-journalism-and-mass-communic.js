...
const Diploma_in_Journalism_and_Mass_Communication = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage3">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">The curriculum is evenly balanced for imparting technical skills and theoretical knowledge<br /> in various
                        domains of Mass Communication and Mass Media,which determine the <br /> nature use, historical and social
                        understanding of the social dynamics.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Diploma in Journalism and Mass Communication (D-JMC)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    <Col lg={3} className="ordersss">
                        ...
                        <ul className="abcd1111">
                            ...
                            <li className="acdsds"><Link to='/Journalismandmass'>School of Journalism and Mass Communication</Link></li>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Diploma in Journalism and Mass Communication (D-JMC)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Diploma in Journalism and Mass Communication is a 1-year journalism course designed to
                                            provide the necessary skills and understanding of the journalism sector.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Learn from the faculty having rich academic &amp; industry experience.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Study from a curriculum that is the first-of-its-kind, It has been designed in consultation with
                                            leading media houses.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Students acquire a functional knowledge on the principles and recent emerging trends of the
                                            media industry.
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label"> Students develop communication skills, a sense of creativity, critical thinking an analytical
                                            approach.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Students equipped to conceptualize, create and design high-quality media content for print,
                                            TV, radio, films and various digital platforms like social media, mobile communication etc.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Students demonstrate their ability to produce reliable outcomes which are firmly found on a
                                            socially responsible framework and backed by a decent knowledge of media ethics and law.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_jobinterviews"></div>
                                        </div>
                                        <div class="AboutSection__list__label">We graduate highly competent professionals who have acquired communication and critical
                                            thinking skills appropriate to journalism and to advertising and public relations.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_mentorship"></div>
                                        </div>
                                        <div class="AboutSection__list__label">It comprised of a good mix of formal lectures, seminars, computer-based learning, individual
                                            and group project work, guest lectures and Media house training.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">  The students learn in a simulated environment to produce newspapers, create radio
                                            broadcasts, prepare TV news bulletins, run public relations campaigns, make video films, set
                                            up blogs and work on social media platforms.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_mentorship"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> Students get the chance to interact with the industry experts and gain hands-on knowledge
                                            and understanding about contemporary issues and requirements of the industry.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> Learn to use Adobe Premiere, Adobe Photoshop, Adobe InDesign, Adobe Audition,
                                            Illustrator, Celt and After Effects. Gain from web training and to use it in the profession.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_mentorship"></div>
                                        </div>
                                        <div class="AboutSection__list__label">At the end of the program a student gains proficiency reads to newspapers, television, radio,
                                            digital content management, social media, advertising, public relations, event management,
                                            communication, film studies, and digital photography.</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Diploma_in_Journalism_and_Mass_Communication;