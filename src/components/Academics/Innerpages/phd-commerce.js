        ...
        <React.Fragment>
            ...
            <div className="innerbackimage15">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">A Ph.D. in Commerce is a highly-specialized degree, which helps individuals in a wide variety <br />
                        of fields. The degree is designed to increase the professionally of individuals in the field of <br />
                        commerce and business. This doctoral degree allows candidates to gain in-depth knowledge in <br />
                        the fields of finance and accounting.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Ph.D. & M.Phil. Program (Commerce)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Ph.D. & M.Phil. Program (Commerce)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">PhD in Commerce is a two-year doctoral program.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">The doctoral degree in Commerce and Management provides students with in-depth
                                            knowledge in business and management fundamentals.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label">In its study, the program includes the ideas of Commerce and Management. </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Students who complete the PhD in Commerce and Management program will have the
                                            requisite management skills as well as a working knowledge of company legislation.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">After completing the course, doctorates will be able to conduct their own study as well as
                                            pursue lucrative employment in finance, marketing, research, business, and other
                                            disciplines</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Candidates obtain the capacity to do research in a variety of disciplines of commerce
                                            through the study of subjects such as Human resources, Operations, Productions, and
                                            Business Principles.
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">In the future, this program will bring better work, chances, both the Commerce and
                                            Management sector.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_jobinterviews"></div>
                                        </div>
                                        <div class="AboutSection__list__label">A PhD in Commerce is explicitly oriented to research in the subject of Business and
                                            Commerce.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label"> Discover your area of expertises</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <Col lg={12}>
                            <section>
                                <div class="Career_row">
                                    ...
                                    <ul class="bba">
                                        <p style={{ color: '#5a5a5a' }}><BiRightArrow /> BCOM :- (Select Any One) Marketing | Finance | Banking and Insurance<br />
                                            <BiRightArrow /> MCOM :- (Select Any One) Marketing | Finance | Banking and Insurance<br /><BiRightArrow />  PGDCom :- (Select any One) Banking, Financial Services and Insurance | Investment and Financial Analysis | Merger and Acquisition<br /></p>
                                    </ul>
                                </div>
                            </section>
                        </Col>
