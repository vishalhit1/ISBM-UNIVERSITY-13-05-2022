...
const Mdp_on_effective_communication_for_managers_and_leaders = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage">
                <div className="text_banners_abcds">
                    ...
                    MDP on Effective Communication For Managers And Leaders
                    </h1>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>MDP on Effective Communication For Managers And Leaders</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
...
export default Mdp_on_effective_communication_for_managers_and_leaders