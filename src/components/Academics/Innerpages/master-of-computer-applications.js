...
const Master_of_computer_applications = () => {
    ...
    <React.Fragment>
      ...
      <div className="innerbackimage9">
        <div className="text_banners_abcds">
          ...
          <p className="animate__animated animate__fadeInRightBig">An MCA degree endows students’ an opportunity to work with tools meant to <br />develop better and
      ...
      <Container className="About_us11">
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Master of Computer Applications (MCA)</Breadcrumb.Item>
        </Breadcrumb>
        <Row>
          ...
          <Col lg={9}>
            <div className="row">
              <div className="col-lg-12">
                <h2 className="linkabout123">Master of Computer Applications (MCA)</h2>
                ...
                <ul class="AboutSection__list">
                  <li>
                    ...
                    <div class="AboutSection__list__label">Masters of Computer Applications is a three years program offered at ISBM University.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                  ...
                  <li>
                    ...
                    <div class="AboutSection__list__label">In this section, you will find relevant MCA course information &amp; details that students
                      often look for.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                    ...
                    <div class="AboutSection__list__label">The major thrust is on giving the students a sound background in computing, business
                  ...
                  <li>
                    ...
                    <div class="AboutSection__list__label">To provide complete professional grooming essential to secure a career in the IT industry.
                    </div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                    ...
                    <div class="AboutSection__list__label">To enable students with skills required to work in small as well as big IT industries in the
                      role of system developer and various other profiles.
                    </div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                    ...
                    <div class="AboutSection__list__label">After pursuing MCA, students are eligible to become teachers/lecturers both in private as
                      well as public sector colleges/universities.
                    </div>
                  </li>
...
export default Master_of_computer_applications
