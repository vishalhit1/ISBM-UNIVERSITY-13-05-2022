...
const Master_of_science_in_information_technology = () => {
    ...
    <React.Fragment>
      ...
      <div className="innerbackimage9">
        <div className="text_banners_abcds">
          ...
          <p className="animate__animated animate__fadeInRightBig">By pursuing Master of Science in Information Technology program, students get a good grasp <br />
            over current trends in Information Technology arena, thereby making <br />them more familiar with its
            functioning and structure.</p>
          <button
      ...
      <Container className="About_us11">
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Master of Science in Information Technology (M.Sc.[I.T.])</Breadcrumb.Item>
        </Breadcrumb>
        <Row>
          ...
          <Col lg={9}>
            <div className="row">
              <div className="col-lg-12">
                <h2 className="linkabout123">Master of Science in Information Technology (M.Sc.[I.T.])</h2>
                ...
                <ul class="AboutSection__list">
                  <li>
                    ...
                    <div class="AboutSection__list__label">Master of Science or MSc in information technology IT is a 2 years long post-graduate
                      level master degree program.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                    </div>
                    <div class="AboutSection__list__label">MSc IT aims to provide theoretical as well as practical knowledge on topics like software
                      development, data mining, computer systems, analytics etc.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                  ...
                  <li>
                    ...
                    <div class="AboutSection__list__label">Give students an understanding of programming, database management, database
                      administration, testing, ERP.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                    </div>
                    <div class="AboutSection__list__label">Clear concepts so that students can apply for higher studies after completion of the course
                    </div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                    ...
                    <div class="AboutSection__list__label">Encourage students to opt for certification courses such as programming networking, SE
                      certification, ITIL certification, Six Sigma certification, etc.
                    </div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                    ...
                    <div class="AboutSection__list__label">The MSc IT Syllabus includes important topics like web-development, OS, database
                      management, project management, cyber security, object-oriented programming
                      languages and other related concepts.
                    </div>
                  </li>
...
export default Master_of_science_in_information_technology
