        ...
        <React.Fragment>
            ...
            <div className="innerbackimage4">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">The Diploma in Engineering is a program focused on practical and skills-oriented training.<br /> It
                        aims to provide students with industry or job related engineering knowledge, <br />scientific skills,
                        computing and analysis, mathematical techniques, <br />a sound knowledge of English to
                        communicate in the field and <br />ability to apply problem-solving techniques.</p>
                    <button
            ...
            <section className="BannerSection__programStats">
                <ul className="BannerSection__programStats__box">
                    ...
                    <li className="BannerSection__programStats__static">
                        ...
                        <div className="BannerSection__programStats__static__desc">10th or equivalent</div>
                    </li>
                    <li className="BannerSection__programStats__static">
                        <div className="BannerSection__programStats__static__label">
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Diploma in Engineering (DE)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Diploma in Engineering (DE)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Its duration is minimum 3 years.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">After completing diploma courses, students can get admission to postgraduate diploma
                                            courses to hone their skills and knowledge.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> Diploma students gain solid knowledge of fundamentals of engineering. This helps them
                                            while they pursue B.E. or B. Tech. courses in future.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Students, who can’t join engineering degree courses, get benefit from earning diploma
                                            program both in job-market as well as for further studies.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label"> Diploma in engineering makes students job-ready faster, so their chances of being hired
                                            and valued increase.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">If you are eager to launch your career in engineering, then you can do so after completing
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Since polytechnic diplomas focus on application-based teaching and training, there is
                                            more scope in the job market for such candidates</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Diploma_in_Engineering;