...
const Mdp_on_strategies_for_online_businesses = () => {
            ...
            <Container className="About_us11">
                ...
                <Col lg={3} className="ordersss">
                    ...
                    <Col lg={9} className="ordersss11">
                        <h4 className="programees sasa">Mdp on strategies for online businesses</h4>
...
export default Mdp_on_strategies_for_online_businesses