...
const Certificate_in_Fashion_designing = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage5">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">Certificate in Fashion Designing will act as a stepping stone for students in order<br /> to pursue their
                        higher studies in Fashion Designing.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Certificate in Fashion Designing (CFD)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Certificate in Fashion Designing (CFD)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Certificate Course in Fashion Design is a 1-year certificate course, the minimum
                                            eligibility is 10+2</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">The program will inculcate within students a great fashion sense and a superior
                                            understanding of costumes, garments, patterns and every intricate detailing related to
                                            clothing.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label"> To provide an overview of the fashion industry to students.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label"> Familiarize students with the context and academic structure of design and technology.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">To ensure that students have a fundamental approach to overcome the emerging
                                            challenges of the industry.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Certificate Course in Fashion Design covers all aspects of fashion from idea generation to
                                            the production of an original prototype.
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">The concentration is to perceive their actual potential and build up their inclination in
                                            their subject matter.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_workingprofessional"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> With the establishment in view of the experience, ability, and workshops led by Industry
                                            Professionals the candidates would be able to build up a strong basis of their skill sets.</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Certificate_in_Fashion_designing;