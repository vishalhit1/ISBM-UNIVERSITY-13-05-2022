...
const Master_of_library_and_information_science = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage7">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">Master in Library and Information Science is a post graduate program structured to make
students <br/> understand the significance of preserved records and data and how they are beneficial <br/> 
for various purposes.</p>
            ...
            <section className="BannerSection__programStats">
                <ul className="BannerSection__programStats__box">
                    ...
                    <li className="BannerSection__programStats__static">
                        ...
                        <div className="BannerSection__programStats__static__desc">B.Lib</div>
                    </li>
                    <li className="BannerSection__programStats__static">
                        <div className="BannerSection__programStats__static__label">
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Master of Library and Information Science (M.Lib.)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Master of Library and Information Science (M.Lib.)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Master of Library Science is Post Graduate Academic Degree awarded for a course or
program in the field of Library Science.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">It’s 1 Year Post Graduate Course.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Candidates who a have a Bachelor degree in Library &amp; Information Science/ Library
Science / Information Science or an equivalent degree from a recognized University or
Institution are eligible for pursuing Master’s Degree in Library Science.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">This field is meant for those who want to conduct research as an Information Scientist
and contribute to the development of the field of Information Science. 
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Library Science Degree Course material at Masters level include library networking, on-
line and digital library services, library science research etc.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">The coursework familiarizes students as to how they can carry research and analysis to
collect opinions of people and conclude the study with valid reasoning.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Familiarize students with the art of preserving and organizing useful data.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_jobinterviews"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To inculcate within students the ability to conduct rigorous research in order to acquire
valuable information.</div>
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Acquaint students with profound knowledge needed to gather rare information and data.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">With a postgraduate degree in Library Science, one can get excellent jobs in Libraries or
take up a research-oriented career in the Information Industry.</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Master_of_library_and_information_science;