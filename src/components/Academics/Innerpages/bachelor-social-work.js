        ...
        <React.Fragment>
            ...
            <div className="innerbackimage14">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">The Bachelor in Social Work program will enable students to acquire social morals, <br />principles
                        and values essential to become praiseworthy social workers.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Bachelor of Social Work (BSW)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Bachelor of Social Work (BSW)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">The program through its entire coursework intends to make students understand their
                                            social obligations and improve themselves in order to benefit the entire community.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Implement effective communication and planned approach so as to deliver the right
                                            message to the society.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Integrate social welfare policies with a professional approach for the betterment of the
                                            public.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Conduct research and social work to review community practices.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">BSW course or Bachelor of Social Work is a professional degree majoring in the field of
                                            social work offered at the undergraduate (UG) level.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Typically, BSW degree course has a duration of three years that is further divided into six
                                            semesters.
                                        </div>
                                    </li>
                                </ul>
...
export default Bachelors_Social_Work;