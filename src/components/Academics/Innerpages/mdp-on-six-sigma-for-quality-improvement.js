...
const Mdp_on_six_sigma_for_quality_improvement = () => {
    ...
    return (
        <React.Fragment>
            ...
            <Container className="About_us11">
                ...
                <Breadcrumb.Item active>Mdp on six sigma for quality improvement</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                <Col lg={3} className="ordersss">
                    ...
                    <Col lg={9} className="ordersss11">
                        <h2 className="linkabout123">MDP On Six Sigma For Quality Improvement</h2>
                        <p>Six Sigma is a tool that significantly improves customer satisfaction and shareholder value by reducing waste and variability in every aspect of our business. By following a structured approach, six-sigma helps in better understanding of customers’ needs and wants from their point of view, and be able to build and/or modify processes and products to meet or exceed their expectations.</p>
                        <p>Six Sigma improvement projects targets to reduce the cost of quality in industries. However, the reason for instituting consumer oriented six-sigma goes beyond just the savings. Some of the projects undertaken for six-sigma change the very dynamics of the ways things get done and provide a significant competitive boost to the company or product.</p>
                    </Col>
                </Row>
            </Container>
...
export default Mdp_on_six_sigma_for_quality_improvement