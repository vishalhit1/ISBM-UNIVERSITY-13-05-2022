...
const Post_graduate_diploma_in_business_administration = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage1">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">A post graduate diploma in Business Administration will be of great help in polishing the <br />
                        knowledge and skills acquired during your Bachelors program.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Post Graduate Diploma in Business Administration (PGDBA)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Post Graduate Diploma in Business Administration (PGDBA)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Students at ISBM University have the feasibility to choose from a variety of Post
                                            Graduate Diploma programs thus enabling them to gain expertise and applied familiarity
                                            within a particular field that interests them the most.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To enable students to refine their knowledge received through their graduation
                                            program.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">To let them freely apply the theoretical knowledge in actual functioning’s and
                                            encounter the know how’s of their industry.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To deliver hands-on training coupled with professional approach.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">PG Diploma Business Administration provides information regarding the
                                            business administrations, business operation and management.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">It is a course with less duration, i.e., 1 year which us further divided into 2
                                            semesters.
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">After the completion of the course candidates can prosper in the business
                                            industry.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">The course also teaches how to deal with different types of people as well as the
                                            art of convincing people.</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Post_graduate_diploma_in_business_administration;