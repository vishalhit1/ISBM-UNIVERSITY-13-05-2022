...
const Bachelor_of_science_in_computer_science = () => {
    ...
    <React.Fragment>
      ...
      <Container className="About_us11">
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Bachelor of Science in Computer Science (B.SC-Computer Science)</Breadcrumb.Item>
        </Breadcrumb>
        <Row>
          ...
          <Col lg={9}>
            <div className="row">
              <div className="col-lg-12">
                <h2 className="linkabout123">Bachelor of Science in Computer Science (B.SC-Computer Science)</h2>
                ...
                <ul class="AboutSection__list">
                  <li>
                    ...
                    <div class="AboutSection__list__label">B. Sc. Computer Science is a course which enables students to understand the principles
                      of computers and the way computers function.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                    </div>
                    <div class="AboutSection__list__label">This undergraduate program aims at preparing highly skilled professionals and
                      individuals that possess an extraordinary ability to conduct research and analysis.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                  ...
                  <li>
                    ...
                    <div class="AboutSection__list__label">Empower students to deal with technical issues through advanced level of knowledge in
                      database and analytical skills.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                    </div>
                    <div class="AboutSection__list__label"> Introduce students with the theoretical and mathematical foundation of computing.
                    </div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
...
export default Bachelor_of_science_in_computer_science
