...
const Diploma_in_business_administration = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage1">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">At ISBM University, students not just learn but gain experience that can help them for a lifetime.<br />
                        Our DBA (Diploma in Business Administration) offers an in depth training to function efficiently<br />
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Diploma in Business Administration (DBA)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Diploma in Business Administration (DBA)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">DBA is a course that offers assistance to students in learning business management and
                                            implementing business strategies.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Within the 3 months duration time, students will get a fair idea on how various
                                            businesses function.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Diploma in Business Administration will enhance your professional skills thereby making
                                            you eligible for working in a varied range of industry types.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Based on industry oriented study curriculum, the course encourages you to become an
                                            independent decision maker which is an essential quality required in any business.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">This diploma course lets you explore the functioning of businesses that exist in the
                                            industry.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">People who have an inclination towards commerce, finance, accounts, etc. can
                                            undoubtedly apply for DBA with ISBM.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">There is no single but multiple advantages that will come your way when you pursue this
                                            course.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label"> One can add to their employment opportunities when they have this certification.</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Diploma_in_business_administration;