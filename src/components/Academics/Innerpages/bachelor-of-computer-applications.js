...
const Bachelor_of_computer_applications = () => {
    ...
    <React.Fragment>
      ...
      <div className="innerbackimage9">
        <div className="text_banners_abcds">
          ...
          <p className="animate__animated animate__fadeInRightBig">The degree helps interested students in setting up a sound academic base for <br /> an advanced career
      ...
      <Container className="About_us11">
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Bachelor Of Computer Application (BCA)</Breadcrumb.Item>
        </Breadcrumb>
        <Row>
          ...
          <Col lg={9}>
            <div className="row">
              <div className="col-lg-12">
                <h2 className="linkabout123">Bachelor Of Computer Application (BCA)</h2>
                ...
                <ul class="AboutSection__list">
                  <li>
                    ...
                    <div class="AboutSection__list__label">Bachelor of Computer Application is a three years program offered at ISBM University.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                  ...
                  <li>
                    ...
                    <div class="AboutSection__list__label">In this section, you will find relevant BCA course information &amp; details that students
                      often look for.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
...
export default Bachelor_of_computer_applications
