    ...
    <React.Fragment>
      ...
      <div className="innerbackimage12">
        <div className="text_banners_abcds">
          ...
          <p className="animate__animated animate__fadeInRightBig">As on today, Naturopathy is Recognized and well accepted as an independent System of Medicine. <br />
            Naturopathic medicine treats the patient from the preventive stage through  <br />to serious, chronic and
      ...
      <Container className="About_us11">
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Diploma in Naturopathy (DN)</Breadcrumb.Item>
        </Breadcrumb>
        <Row>
          ...
          <Col lg={9}>
            <div className="row">
              <div className="col-lg-12">
                <h2 className="linkabout123">Diploma in Naturopathy (DN)</h2>
                ...
                <ul class="AboutSection__list">
                  <li>
                    ...
                    <div class="AboutSection__list__label">This diploma program is designed to build on undergraduate studies in naturopathy and related
                      sciences to develop specialist knowledge, skills and attitudes relating to natural medicines.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                    </div>
                    <div class="AboutSection__list__label">Therefore, people can go to Naturopaths for colds, bronchitis, allergies, as well as for heart
                      disease, diabetes, and malignant diseases.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                    </div>
                    <div class="AboutSection__list__label">Naturopathy is fast gaining popularity around the world for its safe and effective healing. In Indian
                      homes, home remedies come before the trip to the doctor.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                    </div>
                    <div class="AboutSection__list__label">All ailments are believed to be caused by what you eat and what you don’t eat.
                    </div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                    ...
                    <div class="AboutSection__list__label">Hence, a traditional Indian doctor will first make slight adjustments to your diet before he
                      prescribes a medicine, which is the last resort.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                    </div>
                    <div class="AboutSection__list__label">Provide clinical training to Program participants.
                    </div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                    ...
                    <div class="AboutSection__list__label">Improve knowledge in areas such as iris analysis, massage therapy, herbal medicine,
                      flower essences, medicine science, research, nutrition and other therapies.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_jobinterviews"></div>
                    </div>
                    <div class="AboutSection__list__label">Enable develop specialist knowledge, skills and attitudes relating to natural medicines.</div>
                  </li>
                </ul>
              </div>
            </div>
...
export default Diploma_in_naturopathy
