...
const Mdp_on_e_governance_and_government_process_change = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage">
                <div className="text_banners_abcds">
                    <h1 className="animate__animated animate__fadeInRightBig">
                        MDP on E-Governance And Government Process Change
                    </h1>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>MDP on E-Governance And Government Process Change</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    <Col lg={3}>
...
export default Mdp_on_e_governance_and_government_process_change