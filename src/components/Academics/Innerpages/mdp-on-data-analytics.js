        ...
        <React.Fragment>
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Mdp on Data Analytics</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9} className="ordersss11">
                        <h2 className="linkabout123">Mdp on Data Analytics</h2>
                    </Col>
                </Row>
            </Container>
...
export default Mdp_on_data_analytics