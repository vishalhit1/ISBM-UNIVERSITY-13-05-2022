...
const Phd_program_information_technology = () => {
    ...
    <React.Fragment>
      ...
      <div className="innerbackimage9">
        <div className="text_banners_abcds">
          ...
          <p className="animate__animated animate__fadeInRightBig">PhD IT is one of the highest degrees offered and any candidate who has completed post-
            graduation <br /> or masters in the respective field. This degree is specialized  for candidates looking
            forward<br /> to launching an extensively active career in the field of information technology.</p>
          <button
      ...
      <Container className="About_us11">
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Ph.D. Program (Information Technology)</Breadcrumb.Item>
        </Breadcrumb>
        <Row>
          ...
          <Col lg={9}>
            <div className="row">
              <div className="col-lg-12">
                <h2 className="linkabout123">Ph.D. Program (Information Technology)</h2>
                ...
                <ul class="AboutSection__list">
                  <li>
                    ...
                    <div class="AboutSection__list__label">The Ph.D. Programs at ISBM University&#39;s School of Information and Technology
                      emphasize innovative research work with the implementation of policies designed to
                      improve the research infrastructure and new academic &amp; industry collaborations.</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                    </div>
                    <div class="AboutSection__list__label">The Master of Philosophy (M. Phil.) &amp; Doctor of Philosophy (Ph.D.) programs will
                      provide an opportunity to the students to undertake advanced studies in the subject in
                  ...
                  <li>
                    ...
                    <div class="AboutSection__list__label">ISBM University offers M.Phil. / Ph.D. programs under the guidelines prescribed by the
                      University Grants Commission UGC (2016).</div>
                  </li>
                  <li>
                    <div class="AboutSection__list__icon">
                      <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
...
export default Phd_program_information_technology
