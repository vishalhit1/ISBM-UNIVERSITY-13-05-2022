...
const Certificate_in_computer_design = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage">
                <div className="text_banners_abcds">
                    <h1 className="animate__animated animate__fadeInRightBig">
                        Certificate in Computer Design
                    </h1>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Certificate in Computer Design</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9} className="ordersss11">
                        <h2 className="linkabout123">Certificate in Computer Design</h2>
                        <p>Certificate programs in computer design include programs that teach students how to create art on the computer. Certificate programs in computer design allow students to develop skills in the digital arts. They include coursework and laboratory components, and may culminate with practicum experiences.</p>
                    </Col>
                </Row>
            </Container>
...
export default Certificate_in_computer_design