...
const Diploma_in_hotel_management_and_catering_technology
    = () => {
            ...
            <React.Fragment>
                ...
                <div className="innerbackimage10">
                    <div className="text_banners_abcds">
                        ...
                        <p className="animate__animated animate__fadeInRightBig">The objective of Diploma in Hotel Management program is to provide eligible candidates with
                            the <br />necessary skills, knowledge, values, and attitudes to occupy key <br />operational positions in the
                            hotel industry.</p>
                        <button
                ...
                <section className="BannerSection__programStats">
                    <ul className="BannerSection__programStats__box">
                        ...
                        <li className="BannerSection__programStats__static">
                            ...
                            <div className="BannerSection__programStats__static__desc">10</div>
                        </li>
                        <li className="BannerSection__programStats__static">
                            <div className="BannerSection__programStats__static__label">
                ...
                <Container className="About_us11">
                    <Breadcrumb>
                        ...
                        <Breadcrumb.Item active> Diploma in Hotel Management and Catering Technology (DHMCT)</Breadcrumb.Item>
                    </Breadcrumb>
                    <Row>
                        ...
                        <Col lg={9}>
                            <div className="row">
                                <div className="col-lg-12">
                                    <h2 className="linkabout123"> Diploma in Hotel Management and Catering Technology (DHMCT)</h2>
                                    ...
                                    <ul class="AboutSection__list">
                                        <li>
                                            ...
                                            <div class="AboutSection__list__label">ISBM University offers three years diploma program in hotel management and catering
                                                technology to inculcate quick employability in stude</div>
                                        </li>
                                        <li>
                                            <div class="AboutSection__list__icon">
                                                <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                            </div>
                                            <div class="AboutSection__list__label">This would attract students oriented towards skill based learning carried out mostly in the
                                                labs or through internships and live projects.</div>
                                        </li>
                                        <li>
                                            <div class="AboutSection__list__icon">
                                                <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                            </div>
                                            <div class="AboutSection__list__label">The focus is on food and beverage, operations, housekeeping and maintenance.</div>
                                        </li>
                                        <li>
                                            <div class="AboutSection__list__icon">
                                                <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                            </div>
                                            <div class="AboutSection__list__label">The program is in huge demand across the hotel industry, event management companies,
                                                restaurants, industry, educational institutions and similar other service sectors.
                                            </div>
                                        </li>
                                        <li>
                                            <div class="AboutSection__list__icon">
                                            ...
                                            <div class="AboutSection__list__label">A diploma in hotel management opens immense opportunities in the large hospitality and
                                                tourism industry which include hotels and restaurants etc.</div>
                                        </li>
                                        <li>
                                            <div class="AboutSection__list__icon">
                                                <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                            </div>
                                            <div class="AboutSection__list__label">They can also work for catering services that serve private and public organizations.
                                                These include cafeterias owned by Government organizations and corporate houses.
                                            </div>
                                        </li>
                                        <li>
                                            <div class="AboutSection__list__icon">
                                            ...
                                            <div class="AboutSection__list__label">The public sector organizations also include schools, colleges and community centers.</div>
                                        </li>
                                        <li>
                                            <div class="AboutSection__list__icon">
                                                <div class=" brand-icon-retina brand-icon-retina_jobinterviews"></div>
                                            </div>
                                            <div class="AboutSection__list__label">Since the Hospitality and Tourism industry is progressing by leaps and bounds the
                                                employment opportunities are almost endless.</div>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
export default Diploma_in_hotel_management_and_catering_technology
    ;