...
const Certificate_in_jewellery_design = () => {
        ...
        <React.Fragment>
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Certificate in Jewellery Design</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
...
export default Certificate_in_jewellery_design