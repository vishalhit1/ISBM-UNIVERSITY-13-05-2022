        ...
        <React.Fragment>
            ...
            <div className="innerbackimage2">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">Transform your career with a MBA Degree from a top UK business school. <br />
                        Focus your journey on a functional track - Finance, Marketing, Strategy & Leadership, Operations, Analytics, HR. <br />
                        Experience an immersion programme in the UK.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Bachelors in Science (B.Sc)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Bachelors in Science (B.Sc)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Enrolling in a BSc degree program translates to making a significant
                                            investment in one&#39;s professional career.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To provide education in Physics of the highest quality at the undergraduate
                                            level and generate graduates of the caliber sought by industries and public
                                            service as well as academic teachers and researchers of the future.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> To attract outstanding students from all backgrounds.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To provide an intellectually stimulating environment in which the students
                                            have the opportunity to develop their skills and enthusiasms to the best of
                                            their potential.
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label"> To impart the skills required to gather information from resources and use
                                            them.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Developed their experimental and data analysis skills through a wide range
                                            of experiments in the practical laboratories.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">The high requirement for BSc degrees helps students develop skills that
                                            are more in line with what the employers seek.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_jobinterviews"></div>
                                        </div>
                                        <div class="AboutSection__list__label">A BSc degree can open flood gates of job opportunities in the field of
                                            science.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Specializations like BSc computer science, BSc IT, artificial intelligence,
                                            biotechnology, and environmental technology, have led to high demand for
                                            science graduates.s</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Bachelors_In_Science;