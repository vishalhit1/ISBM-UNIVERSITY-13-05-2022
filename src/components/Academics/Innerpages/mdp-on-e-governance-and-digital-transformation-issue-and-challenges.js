...
const Mdp_on_e_governance_and_digital_transformation_issue_and_challenges = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage">
                <div className="text_banners_abcds">
                    ...
                    MDP On E-Governance And Digital Transformation: Issue And Challenges
                    </h1>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>MDP On E-Governance And Digital Transformation: Issue And Challenges</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9} className="ordersss11">
                        <h2 className="linkabout123">MDP On E-Governance And Digital Transformation: Issue And Challenges</h2>
                        <p>E-governance initiatives are common in most countries, including industrialized economies, emerging economies, and developing economies. In spite of the worldwide diffusion of e-governance initiatives, getting the claimed benefits of e - Governance has not been easy for various technological as well as organizational reasons.</p><p>E-governance initiatives are challenged by the phenomenon of changing citizen requirements, shifting benchmarks and elusive outcomes. Consequently, there has been significant interest in planning and on developing e-governance best practices and applying them to ensure that e-governance programmes and initiatives are on the right track and are more aligned to outcomes. A systematic process of planning improves citizen centricity, service orientation and transparency in public service delivery and leads to better inclusion of marginalized groups, women, and minorities.</p>
                    </Col>
                </Row>
            </Container>
...
export default Mdp_on_e_governance_and_digital_transformation_issue_and_challenges