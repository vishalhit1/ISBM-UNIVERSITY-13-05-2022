...
const Bachelor_of_science_in_interior_designing = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage5">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">A degree in fashion designing means you have the right skills and experience to work anywhere.<br />
                        The course will teach you about the fashion industry plus you  will gain command over<br /> your
                        fashion skills.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Bachelor of Science in Interior Design (B.Sc-ID)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Bachelor of Science in Interior Design (B.Sc-ID)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Interior Design is a creative program for those who have a mind filled with ideas and
                                            concepts soaring to be implemented and put on paper.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">The students will learn how to structure their thoughts in a more socially acceptable
                                            sequence that would appeal to the client body when they begin working in their field.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To program will lead students to gain accountabilities and traits that professionals
                                            pertaining to similar fields carry.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> To expose students to an intellectually stimulating learning environment covering all the
                                            lengths and breaths of interior design.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label"> Provide students with interior design skills that are of the highest industry standards.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Introduce them to an industry relevant curriculum that contains a balance of both
                                            theoretical as well as practical concepts.
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Make students aware of the approach as to how creative ideas can be conceived and
                                            implemented while working in dynamic work settings in India as well as abroad.</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Bachelor_of_science_in_interior_designing;