...
const Certificate_in_interior_design = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage5">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">Interior design is the process of transforming an internal space by implementing <br/>creative and
technical solutions for how to design, furnish or decorate it.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Certificate in Interior Design (CID)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Certificate in Interior Design (CID)</h2>
...
export default Certificate_in_interior_design;