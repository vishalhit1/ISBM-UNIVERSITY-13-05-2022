...
const Mdp_on_story_telling_and_theater_techniques = ()=>{
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage">
                <div className="text_banners_abcds">
                    ...
                    MDP on Story Telling And Theater Techniques
                    </h1>
                    <button
            ...
            <Container className="About_us11">
                ...
                <Breadcrumb.Item active>MDP on Story Telling And Theater Techniques</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                <Col lg={3}  className="ordersss">
                    ...
                    <Col lg={9}  className="ordersss11">
                        <h2 className="linkabout123">MDP on Story Telling And Theater Techniques</h2>
                        <p>Communication is vital to a successful corporate career, whether individual or brand related; technology or interpersonal and formal or casual. Storytelling and Theater are two time-honored techniques which are relevant in contemporary business including digital. On one hand while Theatrical techniques build on effective interpersonal and group communication skills, the Story Telling talks around building more effective and Engaging Content for Communication, Consumption and Actio</p>
                    </Col>
                </Row>
            </Container>
...
export default Mdp_on_story_telling_and_theater_techniques