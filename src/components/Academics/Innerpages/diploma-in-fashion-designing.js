...
const Diploma_in_fashion_designing = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage5">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">Fashion design is the applied art dedicated to the design of clothing and lifestyle.<br />accessories
                        created within the cultural and social influences of a specific time.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Diploma in Fashion Designing (DFD)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Diploma in Fashion Designing (DFD)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Aspirants who wish to broaden their career prospects in the field of fashion can pursue a
                                            Diploma in Fashion Designing.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Clothing production, assembling garments, Pattern grading and making, Design concepts,
                                            Apparel training are certain aspects that will be covered under this course.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To provide an overview of the fashion industry to students.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Fashion Design is the investigation of making unique plans which include changing over
                                            masterful ability and imagination in making items like dress, materials, gems, footwear
...
export default Diploma_in_fashion_designing;