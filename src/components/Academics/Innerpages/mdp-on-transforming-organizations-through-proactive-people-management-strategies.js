...
const Mdp_on_transforming_organizations_through_proactive_people_management_strategies = () => {
        ...
        <React.Fragment>
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>MDP on Transforming Organizations Through Proactive People Management Strategies</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9} className="ordersss11">
                        <h2 className="linkabout123">MDP on Transforming Organizations Through Proactive People Management Strategies</h2>
                        <p>The programme was designed and organized for the senior and middle-level line managers, functional executives, HR managers, and department and section heads from Private, Public and Multi-National Companies (MNCs) that are concerned about developing and implementing effective people policies.</p>
...
export default Mdp_on_transforming_organizations_through_proactive_people_management_strategies