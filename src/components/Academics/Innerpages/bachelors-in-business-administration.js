...
const Bachelors_in_business_administration = () => {
        ...
        <React.Fragment>
            ...
            <div className="innerbackimage1">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">The BBA aims at preparing young minds for responsible positions in Industry, <br />trade, commerce
                        and other services with high level of motivation.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Bachelors in Business Administration (BBA)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Bachelors in Business Administration (BBA)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">BBA is an undergraduate program which provides advanced knowledge of
                                            Management. </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Our Bachelor of Business Administration is designed to teach foundational concepts, like
                                            finance and accounting, and provide a core understanding of business- and marketing-
                                            related fields.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">The BBA curriculum meets the corporate requirements.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Professionalism and management skills are inculcated among the students both at the
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Efforts are made to motivate students to realize their goals in difficult and divergent
                                            situations through various interactive sessions and assignments.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Develop Interpersonal and multi-cultural teamwork competency.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Encourage Innovation and creativity among Finance professionals.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_jobinterviews"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Provide exposure on handling of transaction using technology.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_mentorship"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Create an ability to analyze, evaluate and strategize and Implement Management
                                            concepts and Theories.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">It focuses on knowledge and skills required by management professionals who
                                            plan to work for Indian and multinational corporations.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_mentorship"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> It provides the students with general management perspective and introduces
                                            them to the latest concepts and practices related to functions of administration
                                            and management.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">Analyze and design superior business and transformation processes.</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Bachelors_in_business_administration;