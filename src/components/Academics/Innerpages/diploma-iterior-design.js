        ...
        <React.Fragment>
            ...
            <div className="innerbackimage5">
                <div className="text_banners_abcds">
                    ...
                    <p className="animate__animated animate__fadeInRightBig">Interior designers help firms/homeowners in planning out the layout, structure, <br />colour schemes,
                        furnishings, and decorations of their properties.</p>
                    <button
            ...
            <Container className="About_us11">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item active>Diploma in Interior Design (DID)</Breadcrumb.Item>
                </Breadcrumb>
                <Row>
                    ...
                    <Col lg={9}>
                        <div className="row">
                            <div className="col-lg-12">
                                <h2 className="linkabout123">Diploma in Interior Design (DID)</h2>
                                ...
                                <ul class="AboutSection__list">
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Choosing an interior designing course will open the door of tremendous career
                                            opportunities in front of you.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_certification"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> If you believe that you have a creative, futuristic, imaginative, and artistic approach to the
                                            things around you, then you can definitely think of interior designing as a career path.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_campusaccess"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> Choosing an interior designing course can be also perceived as a choosing to make a
                                            difference and a positive change in the world we live in.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_alumnistatus"></div>
                                        </div>
                                        <div class="AboutSection__list__label"> Interior designers can make impact on the lives of people in a given environment.
                                        </div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                        ...
                                        <div class="AboutSection__list__label">  Start Your Own Interior Design Firm.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_networking_colored"></div>
                                        </div>
                                        <div class="AboutSection__list__label">Working in a Design Firm
                                    ...
                                    <li>
                                        ...
                                        <div class="AboutSection__list__label">Providing in depth knowledge to students pertaining to arranging furniture, choosing
                                            décor, color schemes.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_workingprofessional"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To ensure that student are well versed with the basic concepts of design.</div>
                                    </li>
                                    <li>
                                        <div class="AboutSection__list__icon">
                                            <div class=" brand-icon-retina brand-icon-retina_workingprofessional"></div>
                                        </div>
                                        <div class="AboutSection__list__label">To let students explore workshops and get their hands on training.</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
export default Diploma_Interior_Design;