            ...
            <Breadcrumb.Item active>Complaint Against Caste-based discrimination</Breadcrumb.Item>
                ...
                <Row>
                    <Col lg={3}>
                        ...
                        <p className="links_about active"><Link to='/Complaincaste'>Complaint Against Caste-Based Discrimination</Link></p>
                    </Col>
                    <Col lg={9}>
                        <Row className="complaintcaste">
                            <Col lg={12}>
                                <div style={{border:'solid #0a3f7a 1px'}}>
                                <h5>COMPLAINT AGAINST CASTE-BASED DISCRIMINATION</h5>
