        ...
        >
          <div class="item">
            <div className="Instructors__list__item">
              ...
              <Link to="/campusinfrastructure" class="career_btn">
                View Details
              </Link>
            </div>
          </div>
          <div class="item">
            <div className="Instructors__list__item">
              ...
              <Link to="/library" class="career_btn">
                View Details
              </Link>
            </div>
          </div>
          <div class="item">
            <div className="Instructors__list__item">
              ...
              <Link to="/Sports" class="career_btn">
                View Details
              </Link>
            </div>
          </div>
          <div class="item">
            <div className="Instructors__list__item">
              <div className="facilities_img">
                <img src="https://cdn-icons-png.flaticon.com/512/233/233433.png"></img>
              </div>
              <h3 className="faculties_name">Hostel</h3>
              <p className="faculties_text">
              ...
              <Link to="/Hostel" class="career_btn">
                View Details
              </Link>
            </div>
          </div>
          <div class="item">
            <div className="Instructors__list__item">
              ...
              <Link to="/Bustransformation" class="career_btn">
                View Details
              </Link>
            </div>
          </div>
