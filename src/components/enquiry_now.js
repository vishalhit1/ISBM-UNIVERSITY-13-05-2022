...
function Enquiry_now(props) {
    // const[emaildata]= useState({name:"",email:"",location:"",phone:"",course:""});
    // const {name,email,location,phone,course } = emaildata;
    //   const onSubmit = async e => {
    //     e.preventDefault();
    //     await axios.post("http://insity.org.in/api/upload_system_enquiry_data_for_react.php");
    ...
    const[emaildata,setEmail]= useState({name:"",email:"",phone:"",location:"",course:"",remark:"comment",pagename:"Enquiry Form",websitename:"ISBM University"});
    const {name,email,location,phone,course} = emaildata;
    ...
    return (
      <Modal className="enquiry_formss"
        {...props}
